...
<body>
    <div class="wrapper">
        ...
        <div class="user-profile">
            <c:if test="${RESP_PROFILE_UPDATE_RESULT_STATUS != null}">
                <div class="user-profile__result user-profile__result_${RESP_PROFILE_UPDATE_RESULT_STATUS}">${RESP_PROFILE_UPDATE_RESULT_MESSAGE}</div>
            </c:if>
