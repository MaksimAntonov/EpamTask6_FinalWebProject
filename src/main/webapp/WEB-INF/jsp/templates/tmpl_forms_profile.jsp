...
<div id="modal-user-name-update" class="modal-window modal-window_hidden">
    <div class="modal-window__form">
        ...
        <form method="post" action="<c:url value='controller?command=change_user_name' />" class="forms">
            ...
            <input class="forms__element forms__input" id="user_first_name" name="${KEY_USER_FIRST_NAME}" type="text" data-invalid-text="${LOCALE[TEXT_FORM_ERROR_FIRST_NAME_TEXT]}" pattern="${VALIDATION_NAME_PATTERN}" placeholder="Maksim" value="${USER_OBJ.firstName}" required/>
            <label class="forms__element" for="user_last_name">${LOCALE[TEXT_REGISTRATION_LAST_NAME]}:</label>
            <input class="forms__element forms__input" id="user_last_name" name="${KEY_USER_LAST_NAME}" type="text" data-invalid-text="${LOCALE[TEXT_FORM_ERROR_LAST_NAME_TEXT]}" pattern="${VALIDATION_NAME_PATTERN}" placeholder="Antonov" value="${USER_OBJ.lastName}" required/>
...
<div id="modal-user-phone-update" class="modal-window modal-window_hidden">
    <div class="modal-window__form">
        ...
        <form method="post" action="<c:url value='controller?command=change_user_phone' />" class="forms">
            ...
            <input class="forms__element forms__input" id="user_phone" name="${KEY_USER_PHONE}" type="tel" data-invalid-text="${LOCALE[TEXT_FORM_ERROR_PHONE_TEXT]}" pattern="${VALIDATION_PHONE_PATTERN}" placeholder="+375 (29) 123-45-67" value="${USER_OBJ.phone}" required/>
...
<div id="modal-user-password-update" class="modal-window modal-window_hidden">
    <div class="modal-window__form">
        ...
        <form method="post" action="<c:url value='controller?command=change_user_password' />" class="forms">
            ...
            <input class="forms__element forms__input" id="user_pass" name="${KEY_USER_PASSWORD}" type="password" data-invalid-text="${LOCALE[TEXT_FORM_ERROR_PASSWORD_TEXT]}" pattern="${VALIDATION_PASSWORD_PATTERN}" required/>
            <label class="forms__element" for="user_pass_conf">${LOCALE[TEXT_REGISTRATION_PASSWORD_CONFIRM]}:</label>
            <input class="forms__element forms__input" id="user_pass_conf" name="${KEY_USER_PASSWORD_CONFIRM}" type="password" data-invalid-text="${LOCALE[TEXT_FORM_ERROR_PASSWORD_TEXT]}" pattern="${VALIDATION_PASSWORD_PATTERN}" required/>
